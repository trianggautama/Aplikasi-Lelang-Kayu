                         ...
                         <div class="form-group">
                            <label for="exampleSelectGender">Status</label>
                                <select class="form-control" name="status" id="exampleSelectGender">
                                  <option @if(isset($Karyawan->status) && $Karyawan->status == '1')  {{'selected'}} @endif value="1">Menikah</option>    
                                  <option @if(isset($Karyawan->status) && $Karyawan->status == '2')  {{'selected'}} @endif value="2">Belum Menikah</option>       
                                </select>
                                {{ csrf_field() }}
                            </div>
